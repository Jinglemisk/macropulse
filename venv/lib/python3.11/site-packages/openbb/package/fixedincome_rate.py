...
maturity : str | str
    ...
    Choices for fred: 'all', 'overnight', 'average_30d', 'average_90d', 'term_30d'
        'term_90d'
frequency : str
...
Frequency aggregation to convert daily data to lower frequency.
 ...
 (provider: fred)
    Choices for fred: 'a', 'q', 'm', 'w', 'wef', 'weth', 'wew', 'wetu', 'wem', 'wesu', 'wesa', 'bwew'
        'bwem'
...
parameter : str
    ...
    Choices for fred: 'rate', 'index', '10th_percentile', '25th_percentile', '75th_percentile'
        '90th_percentile', 'total_nominal_value'
