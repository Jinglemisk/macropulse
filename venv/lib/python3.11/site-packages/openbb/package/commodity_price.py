...
commodity : str
    ...
    Choices for fred: 'wti', 'brent', 'natural_gas', 'jet_fuel', 'propane', 'heating_oil'
        'diesel_gulf_coast', 'diesel_ny_harbor', 'diesel_la', 'gasoline_ny_harbor'
        'gasoline_gulf_coast', 'rbob', 'all'
frequency : str
