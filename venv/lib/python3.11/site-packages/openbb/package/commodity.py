...
category : str
    ...
    Choices for eia: 'balance_sheet', 'inputs_and_production', 'refiner_blender_net_production'
        'crude_petroleum_stocks', 'gasoline_fuel_stocks', 'total_gasoline_by_sub_padd'
        'distillate_fuel_oil_stocks', 'imports', 'imports_by_country'
        'weekly_estimates', 'spot_prices_crude_gas_heating'
        'spot_prices_diesel_jet_fuel_propane', 'retail_prices'
table : str | None
...
weekly
    ...
    Choices for eia: 'all', 'conventional_gas', 'crude', 'crude_production', 'crude_production_avg'
        'diesel', 'ethanol_plant_production', 'ethanol_plant_production_avg', 'exports'
        'exports_avg', 'heating_oil', 'imports', 'imports_avg', 'imports_by_country'
        'imports_by_country_avg', 'inputs_and_utilization', 'inputs_and_utilization_avg'
        'jet_fuel', 'monthly', 'net_imports_inc_spr_avg', 'net_imports_incl_spr'
        'net_production', 'net_production_avg', 'net_production_by_product'
        'net_production_by_production_avg', 'product_by_region', 'product_by_region_avg'
        'product_supplied', 'product_supplied_avg', 'propane', 'rbob'
        'refiner_blender_net_production', 'refiner_blender_net_production_avg', 'stocks'
        'supply', 'supply_avg', 'ulta_low_sulfur_distillate_reclassification'
        'ulta_low_sulfur_distillate_reclassification_avg', 'weekly'
use_cache : bool
...
10b: Crude Oil and Natural Gas Production from Shale and Tight Formations (provider: eia)
    Choices for eia: '01', '02', '03a', '03b', '03c', '03d', '03e', '04a', '04b', '04c', '04d', '05a'
        '05b', '06', '07a', '07b', '07c', '07d1', '07d2', '07e', '08', '09a', '09b'
        '09c', '10a', '10b'
frequency : str
