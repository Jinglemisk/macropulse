...
An empty search query will return all series within the category. Options are:
    ...
    tu - Time Use
 (provider: bls)
    Choices for bls: 'cpi', 'pce', 'ppi', 'ip', 'jolts', 'nfp', 'cps', 'lfs', 'wages', 'ec', 'sla'
        'bed', 'tu'
include_extras : bool
...
topic : str | str
    ...
    Choices for fred: 'business_outlook', 'hours_worked', 'employment', 'inventories'
        'prices_received', 'prices_paid', 'capex', 'unfilled_orders', 'new_orders'
        'shipments', 'delivery_times'
...
topic : str | str
    The topic for the survey response. Multiple comma separated items allowed. (provider: fred)
    Choices for fred: 'business_activity', 'business_outlook', 'capex', 'prices_paid', 'production'
        'inventory', 'new_orders', 'new_orders_growth', 'unfilled_orders', 'shipments'
        'delivery_time', 'employment', 'wages', 'hours_worked'
frequency : str
...
provider : str
    The provider to use, by default None. If None, the priority list configured in the settings is used. Default priority: fred.
date : date | str | list[date | str | None] | None
...
category : str
    ...
    Choices for fred: 'employees_nsa', 'employees_sa', 'employees_production_and_nonsupervisory'
        'employees_women', 'employees_women_percent', 'avg_hours'
        'avg_hours_production_and_nonsupervisory', 'avg_hours_overtime'
        'avg_hours_overtime_production_and_nonsupervisory', 'avg_earnings_hourly'
        'avg_earnings_hourly_production_and_nonsupervisory', 'avg_earnings_weekly'
        'avg_earnings_weekly_production_and_nonsupervisory', 'index_weekly_hours'
        'index_weekly_hours_production_and_nonsupervisory', 'index_weekly_payrolls'
...
category : str
    ...
    Choices for fred: 'spreads', 'consumer', 'auto', 'credit_card', 'firms', 'mortgage'
        'commercial_real_estate', 'standards', 'demand', 'foreign_banks'
transform : str
