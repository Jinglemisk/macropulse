...
estimate_type : str
    ...
    Choices for intrinio: 'ebitda', 'ebit', 'enterprise_value'
        'cash_flow_per_share', 'pretax_income'
...
action : str
    ...
    Choices for benzinga: 'downgrades', 'maintains', 'reinstates', 'reiterates', 'upgrades', 'assumes'
        'initiates', 'terminates', 'removes', 'suspends', 'firm_dissolved'
