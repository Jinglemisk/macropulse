...
transaction_type : str
    ...
    Choices for fmp: 'award', 'conversion', 'return', 'expire_short', 'in_kind', 'gift'
        'expire_long', 'discretionary', 'other', 'small', 'exempt', 'otm', 'purchase'
        'sale', 'tender', 'will', 'itm', 'trust'
statistics : bool
...
underlying_shares : float | int | None
