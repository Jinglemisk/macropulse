...
interval : str | str | str
    Time interval of the data to return. (provider: fmp, intrinio, polygon, tiingo, yfinance)
    Choices for intrinio: '1m', '5m', '10m', '15m', '30m', '60m', '1h', '1d', '1W'
        '1M', '1Q', '1Y'
    Choices for tiingo: '1m', '5m', '15m', '30m', '90m', '1h', '2h', '4h', '1d'
        '1W', '1M', '1Y'
    Choices for yfinance: '1m', '2m', '5m', '15m', '30m', '60m', '90m', '1h', '1d'
        '5d', '1W', '1M', '1Q'
    Choices for fmp: '1m', '5m', '15m', '30m', '1h', '4h', '1d'
adjustment : str | str
    Type of adjustment for historical prices. Only applies to daily data. (provider: fmp);
    The adjustment factor to apply. Default is splits only. (provider: yfinance)
    Choices for fmp: 'splits_only', 'splits_and_dividends', 'unadjusted'
...
rate_tenor_unit_rec : int | str | None
...
reset_date_unit_rec : int | str | None
...
rate_tenor_unit_pmnt : int | str | None
...
reset_date_unit_pmnt : int | str | None
...
exchange : str | str | None
    Exchange where the ETF is listed. If not provided, all exchanges are searched. (provider: fmp)
