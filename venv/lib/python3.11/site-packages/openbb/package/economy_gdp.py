...
country : str
    ...
    Choices for oecd: 'argentina', 'asia', 'australia', 'austria', 'belgium', 'brazil', 'bulgaria'
        'canada', 'chile', 'china', 'colombia', 'costa_rica', 'croatia'
        ...
        'new_zealand', 'norway', 'peru', 'poland', 'portugal', 'romania', 'russia'
        'slovak_republic', 'slovenia', 'south_africa', 'spain', 'sweden', 'switzerland'
        'turkey', 'united_kingdom', 'united_states', 'other_major_oil_producers'
        'rest_of_the_world', 'world', 'all'
frequency : str
...
'current_prices', 'volume', and 'capita' are expressed in USD;
    ...
    Choices for oecd: 'current_prices', 'volume', 'capita', 'growth', 'deflator'
...
country : str
    ...
    Choices for oecd: 'oecd', 'oecd_26', 'oecd_europe', 'g7', 'g20', 'euro_area', 'european_union_27'
        'european_union_15', 'nafta', 'argentina', 'australia', 'austria', 'belgium'
        'bulgaria', 'brazil', 'canada', 'chile', 'colombia', 'costa_rica', 'croatia'
        'czech_republic', 'denmark', 'estonia', 'finland', 'france', 'germany', 'greece'
        'hungary', 'iceland', 'india', 'indonesia', 'ireland', 'israel', 'italy'
        'japan', 'korea', 'latvia', 'lithuania', 'luxembourg', 'mexico', 'netherlands'
        'new_zealand', 'norway', 'poland', 'portugal', 'romania', 'russia'
        'saudi_arabia', 'slovak_republic', 'slovenia', 'south_africa', 'spain', 'sweden'
        'switzerland', 'turkey', 'united_kingdom', 'united_states', 'all'
