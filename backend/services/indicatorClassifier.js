 ...
 * - ISM PMIs: High → hawkish (+1), Low → dovish (-1)
 ...
 * - Activity indicators (ISM, confidence): same as FPS
...
function classifyAllIndicators(data) {
  ...
  const indicators = [
    ...
    { name: 'ism_manufacturing', maField: 'ism_manufacturing_ma3' },
    { name: 'ism_services', maField: 'ism_services_ma3' },
    { name: 'chicago_pmi', maField: 'chicago_pmi_ma3' },
